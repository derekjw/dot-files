  ...
  (color-theme-install
   `(color-theme-tango-light
     ...
     ((help-highlight-face . underline)
      ...
      (ibuffer-special-buffer-face . font-lock-keyword-face)
      (ibuffer-title-face . font-lock-type-face))
     (border                       ((t (:background ,alum3))))
     (fringe                       ((t (:background ,alum1))))
     (mode-line                    ((t (:foreground ,alum6 :background ,alum2))))
     (region                       ((t (:background ,alum2))))
     (highlight                    ((t (:background ,alum1))))
     ...
     (font-lock-type-face          ((t (:foreground ,cham3))))
     (font-lock-variable-name-face ((t (:foreground ,alum5))))
     (font-lock-warning-face       ((t (:foreground ,orange3))))
     (font-lock-function-name-face ((t (:foreground ,butter3))))
     (comint-highlight-prompt      ((t (:foreground ,cham3))))
     (isearch                      ((t (:background ,orange2 :foreground ,alum1))))
     (isearch-lazy-highlight-face  ((t (:foreground ,alum1 :background ,choc3))))
     (show-paren-match-face        ((t (:foreground ,alum1 :background ,cham2))))
     (show-paren-mismatch-face     ((t (:background ,plum3 :foreground ,alum1))))
     (minibuffer-prompt            ((t (:foreground ,blue3))))
     (info-xref                    ((t (:foreground ,blue3))))
     (info-xref-visited            ((t (:foreground ,plum3))))
     (compilation-warning          ((t (:foreground ,butter3))))
     (compilation-info             ((t (:foreground ,alum5))))
     )))
